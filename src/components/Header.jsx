				...
				<div className="header__row">
					<div className="header__control">
						...
						<div className="header__control-item login">
							...
							<label htmlFor="modal-login" className="header__control-text">Login</label>
							<img src="img/user_icon.png" alt="" />
							<div className="header__modal modal">
								<form action="" className="modal__form">
									<label htmlFor="modal-login" className="modal__close">&times;</label>
					...
					<div className="header__logo"><a href="home.html">bloger</a></div>
